...
cube = Cuboid_3d(Point([0, 0, 0]), Point([30, 30, 30]))
cube = Phantom(geometry=cube, material=silicon)

delta, beta = discrete_phantom(cube, 32, prop=['delta', 'beta'], ratio=1, fix_psize=True, energy=25)
